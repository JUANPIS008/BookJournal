...
- [Visión general](#1-visión-general)
  - [Descripción del proyecto y dominio elegido](#11-descripción-del-proyecto-y-dominio-elegido)
  - [Stack tecnológico utilizadon](#12-stack-tecnológico-utilizado)
  - [URL de acceso a la aplicación desplegada](#13-url-de-acceso-a-la-aplicación-desplegada)
  - [Funcionalidades principales](#14-diagrama-de-arquitectura-del-sistema)
  - [Credenciales de prueba](#15-credenciales-de-prueba)
  - [Problemas encontrados y soluciones](#16-problemas-encontrados-y-soluciones)
- [Estructura del proyecto](#2-estructura-del-proyecto)
- [Modelos de datos](#3-modelos-de-datos)
- [Repositorios](#4-repositorios)
- [Servicios](#5-servicios)
- [Endpoints disponibles](#6-endpoints-disponibles)
- [Parámetros de endpoints](#7-parámetros-de-endpoints)
- [Ejemplos de request y response](#8-ejemplos-de-request-y-response)
- [Ejemplos de request y response](#8-ejemplos-de-request-y-response)
  - [Registro usuarioe](#81-registro-usuario)
  - [Login usuario](#82-login-usuario)
  - [Obtener usuario por id](#83-obtener-usuario-por-id)
  - [Actualizar usuario](#84-actualizar-usuario)
  - [Listar libros](#85-listar-libros)
  - [Libro por id](#86-libro-por-id)
  - [Crear libro](#87-crear-libro)
  - [Actualizar libro](#88-actualizar-libro)
  - [Eliminar libro](#89-eliminar-libro)
  - [Libros leidos](#810-libros-leidos)
  - [Buscar libros](#811-buscar-libros)
  - [Buscar libros](#812-lista-de-deseos)
  - [Crear deseo](#813-crear-deseo)
  - [Eliminar deseo](#814-eliminar-deseo)
- [Códigos de estado HTTP sugeridos](#9-códigos-de-estado-http-sugeridos)
...
- Docker / docker-compose para contenerización y despliegue reproduciblew.
